...
<script type="text/javascript">
    initAoc = function()
    {
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc( 'container1',
                                                    [ [{foreach from=$oxajax.container1 item=aItem key=iKey}]
                                                      ...
                                                      [{/foreach}] ],
                                                    '[{$oViewConf->getAjaxLink()}]cmpid=container1&container=oestatistics_main&synchoxid=[{$oxid}]'
                                                    );
        ...
        YAHOO.oxid.container2 = new YAHOO.oxid.aoc( 'container2',
                                                    [ [{foreach from=$oxajax.container2 item=aItem key=iKey}]
                                                      ...
                                                      [{assign var="sSep" value=","}]
                                                      [{/foreach}] ],
                                                    '[{$oViewConf->getAjaxLink()}]cmpid=container2&container=oestatistics_main&oxid=[{$oxid}]'
                                                    );

        YAHOO.oxid.container1.getDropAction = function()
        {
            return 'fnc=addreporttolist';
        }
        YAHOO.oxid.container2.getDropAction = function()
        {
            return 'fnc=removereportfromlist';
        }
    }
    ...
    <table width="100%">
        ...
        <tr class="edittext">
            <td align="center"><b>[{oxmultilang ident="OESTASTISTIC_MAIN_REPORTS"}]</b></td>
            <td align="center"><b>[{oxmultilang ident="OESTASTISTICS_MAIN_SELREPORTS"}]</b></td>
        </tr>
        <tr>
