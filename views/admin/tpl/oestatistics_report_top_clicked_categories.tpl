<b>[{oxmultilang ident="OESTATISTICS_REPORT_TOP_CLICKED_CATEGORIES"}] :</b><br><br>
[{if $drawStat}]
    ...
    <tr>
      <td class="report_searchstrings_td">
       <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
         <td colspan="[{$allCols}]" align="center"><b>[{oxmultilang ident="OESTATISTICS_REPORT_TOP_CLICKED_CATEGORIES_CLICKPERCAT"}]</b></td>
        </tr>
        <tr>
         <td colspan="[{$allCols}]" align="center">&nbsp;</td>
        </tr>
